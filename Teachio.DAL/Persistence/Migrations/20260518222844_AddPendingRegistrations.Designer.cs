...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Teachio.DAL.Entities.Shared.UserCourse", b =>
                {
            ...
            modelBuilder.Entity("Teachio.DAL.Entities.Users.AvatarFiles.AvatarFile", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Teachio.DAL.Entities.Users.PendingRegistrations.PendingRegistration", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Teachio.DAL.Entities.Users.Users.AppUser", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<System.Guid>", b =>
                {
                    b.HasOne("Teachio.DAL.Entities.Users.Users.AppUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Teachio.DAL.Entities.Courses.Courses.Course", b =>
                {
                    b.HasOne("Teachio.DAL.Entities.Users.Users.AppUser", "OwnerUser")
            ...
            modelBuilder.Entity("Teachio.DAL.Entities.Shared.UserCourse", b =>
                {
                    b.HasOne("Teachio.DAL.Entities.Users.Users.AppUser", "AppUser")
                        .WithMany()
            ...
            modelBuilder.Entity("Teachio.DAL.Entities.Users.AvatarFiles.AvatarFile", b =>
                {
                    b.HasOne("Teachio.DAL.Entities.Users.Users.AppUser", "AppUser")
                        .WithOne("AvatarFile")
                        .HasForeignKey("Teachio.DAL.Entities.Users.AvatarFiles.AvatarFile", "AppUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
