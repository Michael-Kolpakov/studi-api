...
namespace Studi.DAL.Persistence.Migrations
{
    ...
    [Migration("20260529221226_AddSectionCourseIdSectionNameCompositeIndex")]
    partial class AddSectionCourseIdSectionNameCompositeIndex
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Studi.DAL.Entities.Courses.Sections.Section", b =>
                {
                    ...
                    b.HasIndex("CourseId", "SectionName")
                        .IsUnique();
            ...
            modelBuilder.Entity("Studi.DAL.Entities.Courses.Videos.Videos.Video", b =>
                {
                    ...
                    b.ToTable("Videos", "courses", t =>
                        {
                            t.HasCheckConstraint("CK_Video_Description_Regex", "[Description] NOT LIKE '%[^A-Za-z0-9 ,.!?%$#\"'':&()+=*/-–]%'");
            ...
            modelBuilder.Entity("Studi.DAL.Entities.Users.AvatarFiles.AvatarFile", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Studi.DAL.Entities.Users.PendingRegistrations.PendingRegistration", b =>
                {
                    ...
                    b.Property<DateTime>("PinExpiresAtUtc")
                        .HasColumnType("datetime2");
                    ...
                    b.Property<DateTime>("PinSentAtUtc")
                        .HasColumnType("datetime2");
                    ...
                    b.HasIndex("NormalizedEmail")
                        .IsUnique()
                        .HasDatabaseName("IX_PendingRegistration_NormalizedEmail");

                    b.ToTable("PendingRegistrations", "users", t =>
                        {
                            t.HasCheckConstraint("CK_PendingRegistration_Name_Regex", "[Name] NOT LIKE '%[^A-Za-z'' ]%'");

                            t.HasCheckConstraint("CK_PendingRegistration_Surname_Regex", "[Surname] NOT LIKE '%[^A-Za-z'' ]%'");
                        });
                });

            modelBuilder.Entity("Studi.DAL.Entities.Users.Users.AppUser", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("RefreshTokenHash")
                        .HasDatabaseName("IX_AppUser_RefreshTokenHash");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<System.Guid>", b =>
                {
                    b.HasOne("Studi.DAL.Entities.Users.Users.AppUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Studi.DAL.Entities.Courses.Courses.Course", b =>
                {
                    b.HasOne("Studi.DAL.Entities.Users.Users.AppUser", "OwnerUser")
            ...
            modelBuilder.Entity("Studi.DAL.Entities.Courses.Videos.VideoProgress.VideoProgress", b =>
                {
                    b.HasOne("Studi.DAL.Entities.Users.Users.AppUser", "AppUser")
            ...
            modelBuilder.Entity("Studi.DAL.Entities.Users.AvatarFiles.AvatarFile", b =>
                {
                    b.HasOne("Studi.DAL.Entities.Users.Users.AppUser", "AppUser")
                        .WithOne("AvatarFile")
                        .HasForeignKey("Studi.DAL.Entities.Users.AvatarFiles.AvatarFile", "AppUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
