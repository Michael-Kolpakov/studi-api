...
namespace Studi.DAL.Persistence.Migrations
{
    ...
    [Migration("20260502221628_AddUniqueSectionOrderIndex")]
    partial class AddUniqueSectionOrderIndex
    {
        /// <inheritdoc />
                    ...
                    b.ToTable("Videos", "courses", t =>
                        {
                            ...
                            t.HasCheckConstraint("CK_Video_ProcessingError_Regex", "[ProcessingError] NOT LIKE '%[^A-Za-z0-9 .,]%'");
