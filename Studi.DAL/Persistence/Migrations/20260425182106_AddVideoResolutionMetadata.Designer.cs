...
namespace Studi.DAL.Persistence.Migrations
{
    ...
    [Migration("20260425182106_AddVideoResolutionMetadata")]
    partial class AddVideoResolutionMetadata
    {
        /// <inheritdoc />
                    ...
                    b.ToTable("Courses", "courses", t =>
                        {
                            ...
                            t.HasCheckConstraint("CK_Course_ThumbnailName_Regex", "[ThumbnailName] NOT LIKE '%[^A-Za-z0-9.,!?-]%'");
