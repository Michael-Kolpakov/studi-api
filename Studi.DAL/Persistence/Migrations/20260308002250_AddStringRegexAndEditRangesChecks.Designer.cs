...
namespace Studi.DAL.Persistence.Migrations
{
    ...
    [Migration("20260308002250_AddStringRegexAndEditRangesChecks")]
    partial class AddStringRegexAndEditRangesChecks
    {
        /// <inheritdoc />
                    ...
                    b.ToTable("Videos", "courses", t =>
                        {
                            ...
                            t.HasCheckConstraint("CK_Video_VideoName_Regex", "[VideoName] NOT LIKE '%[^A-Za-z0-9.,!?-]%'");
                        });
                });
