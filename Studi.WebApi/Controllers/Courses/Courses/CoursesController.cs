...
using Studi.BLL.CQRS.Courses.Courses.Create;
using Studi.BLL.CQRS.Courses.Courses.Delete;
using Studi.BLL.CQRS.Courses.Courses.Enroll;
using Studi.BLL.CQRS.Courses.Courses.GetById;
using Studi.BLL.CQRS.Courses.Courses.GetByIdPreview;
using Studi.BLL.CQRS.Courses.Courses.GetByIdShort;
using Studi.BLL.CQRS.Courses.Courses.GetPaginated;
using Studi.BLL.CQRS.Courses.Courses.StreamThumbnail;
using Studi.BLL.CQRS.Courses.Courses.Update;
using Studi.BLL.CQRS.Courses.Courses.UploadThumbnail;
...
namespace Studi.WebApi.Controllers.Courses.Courses;
