...
using Studi.BLL.CQRS.Courses.Videos.Videos.Create;
using Studi.BLL.CQRS.Courses.Videos.Videos.Delete;
using Studi.BLL.CQRS.Courses.Videos.Videos.GetById;
using Studi.BLL.CQRS.Courses.Videos.Videos.GetBySectionId;
using Studi.BLL.CQRS.Courses.Videos.Videos.Stream;
using Studi.BLL.CQRS.Courses.Videos.Videos.Update;
using Studi.BLL.CQRS.Courses.Videos.Videos.UpdateOrderIndex;
using Studi.BLL.CQRS.Courses.Videos.Videos.UploadVideo;
...
namespace Studi.WebApi.Controllers.Courses.Videos.Videos;
